...
// Router mappings
router.get("/:id", exports.getSettlement);
router.get("/", exports.getSettlements);
router.post("/", exports.createSettlement);
router.put("/:id", exports.updateSettlement);
router.delete("/:id", exports.deleteSettlement);
